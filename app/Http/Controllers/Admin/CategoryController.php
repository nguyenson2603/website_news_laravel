...
class CategoryController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->params['pagination']['totalItemPerPage'] = 6;
    ...
    public function isHome(Request $request)
    {
        ...
        $this->model->saveItems($this->params, ['task' => 'change-is-home']);
        $ih = $isHome == '1' ? '0' : '1';
        $link = route($this->controllerName . '/is_home', ['isHome' => $ih, 'id' => $id]);
        return response()->json([
            'link' => $link,
            'isHome' => config('zvn.template.is_home.' . $ih),
        ]);
    }
    ...
    public function display(Request $request)
    {
        ...
        $this->model->saveItems($this->params, ['task' => 'change-display']);
        return response()->json([
            'status' => 'success',
        ]);
    }
